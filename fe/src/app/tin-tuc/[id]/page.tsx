  ...
  if (!article) {
    return (
      <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px] py-24 text-center">
        ...
        <Link href="/tin-tuc" className="inline-flex items-center gap-2 bg-[#0562d2] hover:bg-[#00095b] text-white px-6 py-2.5 rounded-full text-sm font-semibold transition">

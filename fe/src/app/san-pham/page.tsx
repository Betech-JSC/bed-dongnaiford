...
export default function ProductsPage() {
  ...
  return (
    <div className="bg-[#fafafa] min-h-screen font-sans pb-16">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#00095B] via-[#02337A] to-[#0562D2] text-white py-16 md:py-20 relative overflow-hidden">
            ...
            <div className="hidden lg:block lg:col-span-1 bg-white border border-gray-200/80 rounded-2xl p-6 shadow-[0px_4px_12px_rgba(16,24,40,0.03)] space-y-6 sticky top-[100px]">
              ...
              <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                <span className="text-[15px] font-bold font-['Ford_Antenna',sans-serif] text-gray-900 flex items-center gap-2">
                  <SlidersHorizontal className="w-4 h-4 text-[#0562d2]" />
                  Bộ lọc xe
                </span>
                {hasActiveFilters && (
                  <button 
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder="Tên xe..."
                    className="w-full text-xs bg-gray-50/50 hover:bg-gray-50 focus:bg-white text-black border border-gray-200 rounded-lg py-2.5 pl-9 pr-8 focus:outline-none focus:border-[#0562d2] transition-colors"
                  />
              ...
              <div className="space-y-3 pt-2">
                <label className="text-xs font-bold text-gray-800 uppercase tracking-wider block">Khoảng giá</label>
                <div className="space-y-2">
                  {[
              ...
              {/* Filter 5: Fuel Type */}
              <div className="space-y-3 pt-2">
                <label className="text-xs font-bold text-gray-800 uppercase tracking-wider block">Nhiên liệu</label>
                <div className="space-y-2">
                  {[
              ...
              <div className="space-y-3 pt-2">
                <label className="text-xs font-bold text-gray-800 uppercase tracking-wider block">Hộp số</label>
                <div className="space-y-2">
                  {[
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-white border border-gray-200/80 rounded-2xl px-6 py-4 flex items-center justify-between shadow-[0px_4px_12px_rgba(16,24,40,0.03)] flex-wrap gap-4">
                <div className="text-left">
                  <h2 className="text-base font-bold font-['Ford_Antenna',sans-serif] text-gray-900">
                    Danh sách xe Ford
                  </h2>
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <Filter className="w-4 h-4 text-[#0562d2]" />
                    <span>Lọc xe ({[
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="bg-white border border-gray-200 text-xs font-semibold text-gray-800 py-2 px-3 rounded-full focus:outline-none focus:border-[#0562d2] cursor-pointer shadow-xs"
                    >
                ...
                <div className="flex items-center gap-2 flex-wrap bg-gray-50/50 p-4 border border-gray-200/60 rounded-xl">
                  ...
                  {selectedCategories.map((cat) => (
                    <span key={cat} className="inline-flex items-center gap-1 bg-white text-[#0562d2] border border-blue-100 rounded-full px-3 py-1 text-xs font-semibold">
                      ...
                      <button onClick={() => toggleCategory(cat)} className="text-[#0562d2]/60 hover:text-[#0562d2] border-0 bg-transparent p-0 cursor-pointer">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  ))}
                  ...
                  {/* Price Tag */}
                  {priceRange && (
                    <span className="inline-flex items-center gap-1 bg-white text-[#0562d2] border border-blue-100 rounded-full px-3 py-1 text-xs font-semibold">
                      <span>{priceRange === "under-800" ? "Dưới 800 triệu" : priceRange === "800-1200" ? "800 triệu - 1.2 tỷ" : "Trên 1.2 tỷ"}</span>
                      <button onClick={() => setPriceRange(null)} className="text-[#0562d2]/60 hover:text-[#0562d2] border-0 bg-transparent p-0 cursor-pointer">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  )}
                  ...
                  {selectedSeats.map((seat) => (
                    <span key={seat} className="inline-flex items-center gap-1 bg-white text-[#0562d2] border border-blue-100 rounded-full px-3 py-1 text-xs font-semibold">
                      <span>{seat} Chỗ</span>
                      <button onClick={() => toggleSeats(seat)} className="text-[#0562d2]/60 hover:text-[#0562d2] border-0 bg-transparent p-0 cursor-pointer">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  ))}
                  ...
                  {selectedFuels.map((fuel) => (
                    <span key={fuel} className="inline-flex items-center gap-1 bg-white text-[#0562d2] border border-blue-100 rounded-full px-3 py-1 text-xs font-semibold">
                      <span>Máy {fuel}</span>
                      <button onClick={() => toggleFuel(fuel)} className="text-[#0562d2]/60 hover:text-[#0562d2] border-0 bg-transparent p-0 cursor-pointer">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  ))}
                  ...
                  {selectedTransmissions.map((trans) => (
                    <span key={trans} className="inline-flex items-center gap-1 bg-white text-[#0562d2] border border-blue-100 rounded-full px-3 py-1 text-xs font-semibold">
                      <span>{trans}</span>
                      <button onClick={() => toggleTransmission(trans)} className="text-[#0562d2]/60 hover:text-[#0562d2] border-0 bg-transparent p-0 cursor-pointer">
                        <X className="w-3 h-3" />
                      </button>
                    </span>
                  ))}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex gap-2 mb-3 items-center flex-wrap">
                        {vehicleType && (
                          <span className="inline-block text-[11px] font-bold text-[#0562D2] bg-blue-50 px-2.5 py-0.5 rounded-md">
                            {vehicleType}
                          </span>
                        )}
                        <span className="inline-block text-[11px] font-bold text-gray-600 bg-gray-100 px-2.5 py-0.5 rounded-md">
                          Động cơ {vehicle.fuel}
                        </span>
                      </div>

                      {/* Title & Price */}
                      <h3 className="text-[17px] font-bold font-['Ford_Antenna',sans-serif] tracking-tight uppercase text-gray-900 group-hover:text-[#0562d2] transition-colors mb-1">
                        {vehicleName}
                      </h3>
                      <p className="text-xs text-gray-500 font-medium mb-4">
                        Giá khởi điểm:{" "}
                        <span className="text-[#0562D2] font-bold text-sm">
                          {formatPrice(vehiclePrice)}
                        </span>
                      </p>

                      {/* Technical specifications panel on card */}
                      <div className="border-t border-gray-100 pt-3 mt-auto mb-4 text-[11px] text-gray-600 space-y-1.5 leading-tight text-left">
              ...
              {sortedVehicles.length === 0 && (
                <div className="text-center py-20 bg-white border border-gray-200/80 rounded-2xl shadow-xs">
                  ...
                  <h3 className="text-base font-bold text-gray-900 mb-1">Không tìm thấy xe phù hợp</h3>
      ...
      <section className="bg-white border-y border-gray-200 py-12">
        <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px]">
          <h2 className="text-xl md:text-2xl font-bold font-['Ford_Antenna',sans-serif] text-[#00095B] text-center mb-8 uppercase tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <Link
                key={tool.href}
                href={tool.href}
                className="flex items-center justify-between p-6 rounded-xl border border-gray-200 hover:border-[#0562d2] hover:shadow-md transition-all group"
              >
                <div>
                  <h3 className="font-bold text-sm text-[#1a1a1a] group-hover:text-[#0562d2] transition-colors">
                    {tool.title}
                  </h3>

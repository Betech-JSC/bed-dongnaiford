...
// Structure of News Articles for Mockup
interface Article {
  id: string;
  title: string;
  category: string;
...
const heroSlides = [
  {
    ...
    image: "https://s3-alpha-sig.figma.com/img/51d8/107c/5660736a8051e7bf365dbc9706b20b6f?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Sr2CekSXuuPUy-ijd0bFhUWLiYilztrYDUdLNLDwYrczx2EEr33oaSb2vDUvkkNXlXv78XiK2QpyxC4S5eXyl4xQyoaMS4dnyxt2e03cBWCIP0qJnPLU-tHegJwbEBPxlkVZzEBKPZbfiK8UPGhkinqGXO9yhGppprVh8s8HupWASffwHLquScgbotWSE4YRAp1y9u0ZTu3-VUv0xWLp6NrQo2Tlx-fP-PBYFvh5bXXmxrd~LHXQWVMd3W4J4iOkdJYMEe3DZNNPS7tt2MaoN2JU1aubXsfmtLWKfn3mdxOYje7pBqAm00mThX~-gMAaJBb-sFZZDESeeJhqd0433Q__",
  ...
  },
  {
    ...
    image: "https://s3-alpha-sig.figma.com/img/36fa/383c/25017866e7fcb87834442bd95d253515?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Jgt9V1KkvxA7D~DVWG2rwHcCAQNgBdeKr0toxDVhcoX0cUAz50b3k8JA64r3wmcV2tLjg2A8GJCDHxr-tEHE1g70KDgHubNjy-gApzUpPz-N5Zi-j--7GRQhQUzb4v~w92~Bn2-Gjq4VUuEdGFHn9dth0pHXbJMZIq8iQN95~SDyCQ2L8ma5NcGimd2Uaj9nOSgTfdfrdz7NtTNcO0EG9bvKLTzfjSCIyfVPzdYNFvbGQU3bZZjP8jCwXRwQYUH9Bj3P~6hQm9D-W~p28TylOVmNras6wt1enTUW8b4mXp6l0zQ0oihvSo7f-M-C2Jf-1QteXazcKmprpxhzEdhbEA__",
  ...
  },
  {
    ...
    image: "https://s3-alpha-sig.figma.com/img/cb5f/178a/ea3b60a6dc2c4dbc569d3a5319f244fe?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=l0InIAbRjJaGlRMygfDpTfYpPlXQoB1rB53KJ9boe9xL7cZFpFJ1aEPc8-7pmCKbCyyY3qkehgMKGnvLRCD9W--JEiV7nn0Gm7t6rcCPrM34jtDmi-3I~kPwXxLfZLRpAQtquJMYF8Vgr1ajwCZe73V9c2p2iJarlnPrvHknni2geB2FrxKsLcGLz0YJRC4EWqkCxbDnAlOVBwLAsb5l7bBWtmHHiLn7Y0tTDyqfa0CPpv-7eKrLyXnmRMYozZsd4vBLLnGLwQKFnKSdkatBEBdXbC3wkyaHPaSHz-LwLt6V-WLBK-MNo6wE-7w3-xl-7P8XYUgoHRDglqRUkyTQiw__",
...
const articles: Article[] = [
  {
    ...
    image: "https://s3-alpha-sig.figma.com/img/3da6/500a/82d363200e89fccd6291e07f206f89ec?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Gdsry4YZ19YmC0u2SlweFEKMMcpUi4GcmPaqSvMnqbeD9mQxo4LBjG0Kcr1ne0HP0WKrj1L5RK-1J-ayA6xO8RuHFqL5GMNSPvlmtZL1OcqTPoQmRxWqv53mQg64~CEC35l11o7weMCxUWTl6X6rU0WqptKaskg2KX4Ksx8qvTYEDcpknq9~dyxPNrqLtTdpCrNx36pNamYCUXBH2KEjwJPStBUt28yBWldeWzFlfuOMfEZ2CfpKlWkFdwVJBxKhDgRoJ-IZAtjKMeu46I6D~V~XuJHbq0QXmvI7vOGomDK0z9yjtnyOs1iwQnIPjnl2ZuIAYQ0Cp0zoiopLPiB6aQ__",
  ...
  },
  {
    ...
    image: "https://s3-alpha-sig.figma.com/img/7f0f/aa99/f348b55e6e378d78c2e72df142ba3718?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=kV~Ff7b1gApSlBWSpacBRL8WpHcYCMqE2PF0txns6I6mu88XAYj9xTqaAiy~ZWMh4MurrEg3Z6JEjWMAFS8fGwBDYM6qFqRk85o7J4kXjdcwf4BxeBTMASqJDgjDEufJc7zClW55kU7I2z-yNQligWx~vHLlGos~AgXHTrRRaVvAnaWk7AgrGhSUxWzsbpMmmFuHOspEp~vbQyPHS-F9~XxFUnqGt3fNmFgWiKGG316uIhnt1A~TJWjzF9RwM6qGpIudUfBs8DTrAZfdMPcQQGCp7C7fQzAKLvExnkvIcw10DTi-JHpnwWozLPVmqvEvH9rPzU5XpRY2~OZMshZSfg__",
  ...
  {
    id: "news-raptor",
    title: "Ford Raptor Nhập Mỹ: Đánh Giá Chi Tiết & Báo Giá Mới Nhất Tại Đồng Nai Ford",
    category: "ĐÁNH GIÁ XE",
    date: "25 Tháng 4, 2026",
    image: "https://s3-alpha-sig.figma.com/img/bac9/531a/dca96f6d0b60cd010285dbd1b205bfa6?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=X4Y-FrdK2EE4HIWpN69QhYe2bnelDwTgNJ1Ja1B6WlcD9atWAv9VXU~DSy328nUS3FLnCA3y4nHmtz~HVQf5GsfMNG3C21fJXPVXPpn0fwQJ947YBwNqINJSa6PdSKnvSGhl~nCXXTLqgJR3bMYMklrr8gQkxPEtmpItMfFEd4fRMk7fUab1myhiWHKbK-MlKeYL8mUOnyiY3EQip2BWfNbN~b6HbFRKrZXCnEYU3k9Mc~jghZx5o4BlHxOpmapVXrU9qh6LnsHeIqEUXaODgGTBZQ3XpgYTM8APv~lTwK6nYFdrsexDtAoYSmN34gjKPXmA2AokjEBtuCAdLUCc3Q__",
    content: "Được phát triển bởi Ford Performance, dòng Ranger Raptor nhập Mỹ sở hữu những nâng cấp vượt trội về hệ thống lái và khung gầm. Cùng Đồng Nai Ford đánh giá chi tiết sức mạnh động cơ Bi-Turbo, 7 chế độ lái thông minh và bảng giá lăn bánh mới nhất."
  }
];
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setActiveNewsIndex((prev) => (prev + 1) % articles.length);
    }, 4500);
    return () => clearInterval(timer);
  }, [isNewsHovered]);
    ...
    <div className="relative min-h-screen bg-light overflow-x-hidden font-sans">
        ...
        <div className="max-w-[1440px] mx-auto w-full px-4 xl:px-[144px] flex flex-col items-center justify-end text-center relative z-10 mt-auto pt-32 pb-[16px] md:pb-[24px]">
          ...
          <div key={activeHeroIndex} className="max-w-3xl flex flex-col items-center text-center reveal-on-scroll">
            ...
            <div className="flex flex-row justify-center gap-[12px] pt-[24px]">
              ...
              <button 
                onClick={() => {
                  const targetVehicle = vehicles.find(v => v.id === heroSlides[activeHeroIndex].linkVehicleId);
                  if (targetVehicle) setSelectedVehicleForModal(targetVehicle);
                }}
          ...
          <div className="flex flex-row justify-center items-start gap-0 max-w-[960px] w-full">
            {heroSlides.map((slide, idx) => (
              <button
                ...
                className={`w-[320px] text-center transition-all duration-300 tracking-[0.18px] text-[18px] font-semibold cursor-pointer ${
                  activeHeroIndex === idx 
              ...
              >
                ...
                <div className="space-y-2 mt-auto">
                  <h3 className={`text-base font-bold tracking-tight uppercase ${
                    vehicle.id === "new-mustang-mach-e" ? "text-[#0562D2]" : "text-[#1A1A1A]"
                  }`}>
                    {vehicle.name}
                  </h3>
              ...
              {[...vehicles, ...vehicles, ...vehicles].map((vehicle, idx) => {
                return (
                  <div
                    key={`${vehicle.id}-${idx}`}
                    onClick={() => setSelectedVehicleForModal(vehicle)}
                    className="relative overflow-hidden rounded-xl h-[595px] group cursor-pointer bg-[#121824] flex-shrink-0 transition-all duration-300"
                    style={{
                      width: 'var(--card-width-popular)',
                    }}
                  >
                    <Image
                      src={getPopularVehicleImage(vehicle)}
                      alt={vehicle.name}
                      fill
            ...
            {vehicles.map((_, idx) => (
              <button
                ...
                className={`h-2 transition-all rounded-full cursor-pointer ${
                  activePopularIndex % vehicles.length === idx ? "w-6 bg-[#0562d2]" : "w-2 bg-gray-300"
                }`}
          ...
          <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px] w-full mt-6">
            ...
            >
              ...
              <div className="absolute inset-0 z-0">
                <Image
                  src="https://s3-alpha-sig.figma.com/img/36fa/383c/25017866e7fcb87834442bd95d253515?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=Jgt9V1KkvxA7D~DVWG2rwHcCAQNgBdeKr0toxDVhcoX0cUAz50b3k8JA64r3wmcV2tLjg2A8GJCDHxr-tEHE1g70KDgHubNjy-gApzUpPz-N5Zi-j--7GRQhQUzb4v~w92~Bn2-Gjq4VUuEdGFHn9dth0pHXbJMZIq8iQN95~SDyCQ2L8ma5NcGimd2Uaj9nOSgTfdfrdz7NtTNcO0EG9bvKLTzfjSCIyfVPzdYNFvbGQU3bZZjP8jCwXRwQYUH9Bj3P~6hQm9D-W~p28TylOVmNras6wt1enTUW8b4mXp6l0zQ0oihvSo7f-M-C2Jf-1QteXazcKmprpxhzEdhbEA__"
                  alt=""
                  fill
      ...
      <section id="services" className="w-full bg-[#f0f0f0] py-[72px]">
        <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px] w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            ...
            <div className="relative overflow-hidden rounded-xl h-[480px] group cursor-pointer bg-white">
              <Image
                src="https://s3-alpha-sig.figma.com/img/b834/9686/2ec41137e82c872509fa1f459436eb70?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=bVlu6N9LkGc1pX8dbDhtWUxWGE4LcD~v0XcV8XmTrktHx3bo546pu5PwIeMoOxRsuVCbOXHljdufqhICDOh5ZjnXH6y56VPFP2yhPkWSDT0B1HAtElLo30rMoj2pUR1G~ASpNdXiz97HS~n4ZX8qbe117g5rI6By6PgEmrVICEYApVr6lvpzTZ3q6HIjoYImp7cM8ccA2ioO49nw~IOx1CllM8alLYpudP2XCLgdoIlPOFyn3bk6hEEHJ4AF0IHBhAjrH5As-CkxabLk4Xqd58Cx19jJ2~-SQ5ELT9SASFIcUfLC9sy-exk7nStxCz3vRQIQK4COIZ6gbAi0ZHJU0g__"
                alt="Chăm sóc khách hàng"
                fill
                className="object-cover transition-transform duration-500 group-hover:scale-105"
              />
              {/* Figma: linear-gradient(to top, rgba(0,0,0,0.9), rgba(0,0,0,0)) */}
              <div className="absolute inset-0" style={{background: 'linear-gradient(to top, rgba(0,0,0,0.9), rgba(0,0,0,0))'}} />
              {/* Figma: pb-32px pt-48px px-16px, text 24px Semibold white */}
            ...
            <div className="relative overflow-hidden rounded-xl h-[480px] group cursor-pointer bg-white">
              <Image
                src="https://s3-alpha-sig.figma.com/img/ce94/fc2e/1e0a7d39634f9f1563f8341e97faa9e3?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=kUqgD4kVE~n60T03cdIosyJ-J9DzYm983Qt0klmRiv1~rsoYCGpwlIPq~ZBB7CV5dtnCl7SC1YzJrf4qpQCF0muqOWGi4kVnGeQ3lVLJlu8jKFF76yANrHpSMtXKGME~pDRZDSEaIf1xy8lmHyXakgMRyPdmVwg5UZmHP8T7vEGhq2Dl2ZfJGBrk1maAFjZ9XoXeuqQSw8VZTEembv6qLz4KE-~zc4cNKoYXf~ozj5yMZ-vmZ2BbRGJ6QLhghwShWik8f8vnSSHzkppVHUhu3l3NEwoNXT6IJy3h6-JhrGTrJAcApSMOvvHaGocD-7kLRWUKhKpTtz5llQJCSfPEUQ__"
                alt="Bảo dưỡng Xe"
                fill
                className="object-cover transition-transform duration-500 group-hover:scale-105"
              />
              ...
              {testimonials.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`h-[320px] bg-white px-6 py-8 rounded-[8px] flex-shrink-0 flex flex-col justify-between cursor-pointer transition-all ${
                      isActive 
          ...
          <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px] flex justify-center gap-2 mt-8">
            {testimonials.map((_, idx) => (
              <button
                ...
                className={`h-2 transition-all rounded-full cursor-pointer ${
                  activeTestimonialIndex === idx ? "w-6 bg-[#0562d2]" : "w-2 bg-gray-300"
                }`}
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b border-white/10 pb-6">
            ...
            <div className="flex items-center gap-6 mt-4 md:mt-0">
              <div className="flex md:hidden gap-2">
                <button 
                  onClick={() => setActiveNewsIndex((prev) => (prev - 1 + articles.length) % articles.length)}
                ...
                <button 
                  onClick={() => setActiveNewsIndex((prev) => (prev + 1) % articles.length)}
                  className="p-2 border border-white/20 hover:bg-white/10 text-white rounded-full transition-colors cursor-pointer bg-transparent"
          ...
          <div className="flex md:hidden justify-center gap-2 mt-6">
            {articles.map((_, idx) => (
              <button
                ...
                className={`h-2 transition-all rounded-full cursor-pointer ${
                  activeNewsIndex === idx ? "w-6 bg-[#0562d2]" : "w-2 bg-white/30"
                }`}
          ...
          <div className="lg:col-span-8 flex flex-col gap-4 w-full">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div 
                  key={idx}
                  className={`relative overflow-hidden border transition-all duration-300 bg-white rounded-lg p-6 ${
                    isOpen 
                ...
                >
                  ...
                  >
                    <span className={`text-base font-semibold transition-colors tracking-tight ${
                      isOpen ? "text-[#0562D2]" : "text-[#1A1A1A]"
                    }`}>
                      {faq.q}
                    </span>
                    {isOpen ? (
                  ...
                  <div className={`absolute bottom-0 left-0 right-0 h-[3px] bg-[#0562D2] transition-opacity duration-300 ${
      ...
      <section id="our-story" className="bg-[#00095b]">
        ...
        <div className="w-full h-[547px] relative">
          <Image
            src="https://s3-alpha-sig.figma.com/img/4d06/10e2/9f02100f7aa3294a7795f640a8f3cf21?Expires=1780272000&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=tGY-4LtnUU-4fiM1XiY3WwMX1s9DHGFXBy1NVhIVdv486o7AP9-6q17brX6L9li2AojvooER4avR7zfCDl0Kav6PxT5vk14~G0A67NJMojw1rPYyouDvMSgFfWBq13DpRJoJLAKgcVcBVFDgowpNShFSl5e1bpaCcGTis8dIAap2Va6iRZ4ekcnT~oDBYs4Jdme666UcVd8cuEl8QVPDxuL-znfi1jl3bOcD9sCBjuzzfdBQRHC6MoKuisv9wPgG-49B9CI5Z0vp-uUqRL4Zjwv~VXabUQ1ABPGakA-T3gW3RHd057jk5ia5nBytlnb7Oqosd3ylJoXU~uHt~mee6Q__"
      ...
      <section id="consultation" className="relative py-20 px-0 w-full overflow-hidden bg-black text-white">
        ...
        <div className="max-w-[1440px] mx-auto px-4 xl:px-[144px] w-full relative z-10">
          ...
          <div className="w-full lg:flex-1 h-[350px] lg:h-[427px] relative rounded-xl overflow-hidden border border-white/10 relative z-10">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img 
              alt="Bản đồ Đồng Nai Ford" 
              className="absolute inset-0 w-full h-full object-cover rounded-xl" 
              src="/showroom_map.png" 
            />
          </div>
        </div>
      </div>
      ...
      {/* HIGH FIDELITY MOCK MODAL 1: VEHICLE DETAIL POPUP */}
      {selectedVehicleForModal && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white text-dark w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-xl shadow-2xl relative border border-gray-200 animate-reveal-on-scroll">
            
            {/* Modal Header */}
            <div className="sticky top-0 bg-primary text-white px-6 py-4 flex justify-between items-center z-10 border-b border-white/10">
              <div>
                <span className="text-[10px] font-black uppercase tracking-widest text-vivid bg-vivid/10 px-2 py-0.5 rounded-md">
                  Thông tin catalog xe
                </span>
              ...
              <button 
                ...
                className="p-1.5 rounded-full bg-white/10 hover:bg-vivid hover:text-white transition-all cursor-pointer text-white"
            ...
            <div className="p-6 md:p-8 space-y-8">
              ...
              {/* Top Section: Split details */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                {/* Images view */}
                <div className="lg:col-span-6 space-y-4">
                  <div className="relative h-64 w-full bg-gray-150 rounded-xl overflow-hidden border border-gray-200">
                    <Image
                  ...
                  {selectedVehicleForModal.images.length > 1 && (
                    <div className="grid grid-cols-2 gap-3">
                      <div className="relative h-28 bg-gray-150 rounded-lg overflow-hidden border border-gray-200">
                        <Image
                          src={selectedVehicleForModal.images[1]}
                          alt={selectedVehicleForModal.name}
                          fill
                          className="object-cover"
                        />
                      </div>
                      <div className="relative h-28 bg-gray-150 rounded-lg overflow-hidden border border-gray-200 flex items-center justify-center bg-primary text-white">
                        <p className="text-center font-bold text-xs uppercase tracking-widest">
                          + Màu sắc <br /> đa dạng
                        </p>
                      </div>
                    </div>
                ...
                <div className="lg:col-span-6 space-y-5">
                  <div className="space-y-2">
                    <span className="text-xs font-bold text-accent uppercase">{selectedVehicleForModal.typeName}</span>
                  ...
                  <div className="space-y-3">
                    <h4 className="font-extrabold text-xs uppercase tracking-wider text-primary pb-1 border-b border-gray-200">
                      Phiên bản & Giá bán tham khảo
                    </h4>
                    <div className="space-y-2">
                      {selectedVehicleForModal.versions.map((ver) => (
                        <div key={ver.id} className="flex justify-between items-center p-3 bg-light border border-gray-100 rounded-lg">
                          <div>
                            <p className="font-extrabold text-primary text-xs uppercase">{ver.name}</p>
                            <p className="text-[10px] text-gray-500 mt-0.5">Tiêu chuẩn kỹ thuật Ford</p>
                          </div>
                          <span className="text-sm font-black text-vivid">{formatPrice(ver.price)}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="space-y-4">
                ...
                {selectedVehicleForModal.versions[0]?.specs && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-6 text-xs border border-gray-150 rounded-lg overflow-hidden bg-light">
                    {[
                      { key: "Động cơ", val: selectedVehicleForModal.versions[0].specs.engine },
                      { key: "Công suất cực đại", val: selectedVehicleForModal.versions[0].specs.power },
                      { key: "Mô-men xoắn cực đại", val: selectedVehicleForModal.versions[0].specs.torque },
                      { key: "Hộp số", val: selectedVehicleForModal.versions[0].specs.transmission },
                      { key: "Hệ dẫn động", val: selectedVehicleForModal.versions[0].specs.drivetrain },
                      { key: "Kích thước (DxRxC)", val: selectedVehicleForModal.versions[0].specs.dimensions },
                      { key: "Khoảng sáng gầm xe", val: selectedVehicleForModal.versions[0].specs.clearance },
                      { key: "Tiêu hao nhiên liệu (kết hợp)", val: selectedVehicleForModal.versions[0].specs.fuelEconomy }
                    ].map((item, idx) => (
                      <div key={idx} className="flex justify-between items-center p-3.5 border-b border-gray-150 last:border-0 md:border-b-0 md:nth-last-2:border-0">
                        <span className="text-gray-500 font-medium">{item.key}:</span>
                        <span className="font-extrabold text-primary text-right pl-4">{item.val}</span>
                      </div>
                    ))}
                  </div>
                )}
              ...
              <div className="pt-6 border-t border-gray-100 flex flex-col sm:flex-row gap-3 justify-end">
                <button 
                  onClick={() => setSelectedVehicleForModal(null)}
                  className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-6 py-2.5 text-xs font-extrabold uppercase tracking-wider rounded-full transition-premium cursor-pointer inline-flex items-center justify-center"
                >
                  Đóng Catalog
                </button>
                <button 
                  onClick={() => {
                    triggerGetQuote(selectedVehicleForModal.id, selectedVehicleForModal.name);
                    setSelectedVehicleForModal(null);
                  }}
                  className="bg-vivid hover:bg-secondary text-white px-8 py-2.5 text-xs font-extrabold uppercase tracking-wider rounded-full transition-premium cursor-pointer shadow-md inline-flex items-center justify-center"
                >
                  Nhận báo giá ngay
                </button>
              </div>
      ...
      {/* HIGH FIDELITY MOCK MODAL 2: NEWS ARTICLE POPUP */}
      {selectedArticleForModal && (
        <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white text-dark w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl shadow-2xl relative border border-gray-200 animate-reveal-on-scroll">
            ...
            <div className="p-6 md:p-8 space-y-6">
              <div className="relative h-64 w-full bg-gray-150 rounded-xl overflow-hidden border border-gray-250">
                <Image
                  src={selectedArticleForModal.image}
              ...
              <div className="space-y-3">
                <span className="text-xs font-semibold text-gray-400">{selectedArticleForModal.date} | Người viết: Ban biên tập Ford Đồng Nai</span>
                <h2 className="text-2xl font-black text-primary uppercase leading-snug tracking-tight">
              ...
              <div className="text-gray-700 text-sm leading-relaxed space-y-4">
                ...
                <p>
                  Đại lý Đồng Nai Ford tự hào cung cấp dịch vụ bán hàng và sau bán hàng hoàn chỉnh nhất khu vực. Quý khách hàng tại thành phố Biên Hòa, huyện Long Thành, Nhơn Trạch, Trảng Bom, Xuân Lộc và toàn tỉnh Đồng Nai luôn nhận được đặc quyền hỗ trợ lái thử tại nhà và chính sách chiết khấu tốt nhất trực tiếp từ nhà máy.
                </p>
                <p>
                  Đội ngũ tư vấn bán hàng của chúng tôi sẵn sàng giải đáp mọi thắc mắc của quý khách hàng về thông số kỹ thuật xe, chi phí lắp đặt phụ kiện cao cấp chính hãng và hỗ trợ các giải pháp tài chính vay ngân hàng tối ưu.
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-gray-100 flex justify-end">
                <button 
                  onClick={() => setSelectedArticleForModal(null)}
                  className="bg-vivid hover:bg-secondary text-white text-xs uppercase font-extrabold tracking-widest py-2.5 px-8 rounded-full transition-premium cursor-pointer shadow-md inline-flex items-center justify-center"
                >
                  Đã Đọc Xong
                </button>
              </div>

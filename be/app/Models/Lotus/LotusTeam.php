...
class LotusTeam extends BaseModel
{
    use SoftDeletes, Translatable;

    protected $table = 'lotus_teams';
    public $translationModel = LotusTeamTranslation::class;
    public $translationForeignKey = 'lotus_team_id';
    ...
    // ─── Cột không dịch (nằm trong lotus_teams) ──────────────────────────────
    protected $fillable = [
        'department',
        'avatar',
        'cover_image',
    ...
    // ─── Cột được dịch (nằm trong lotus_team_translations) ───────────────────
    ...
    public function localizedTranslation(?string $locale = null, bool $fallback = true): ?LotusTeamTranslation
    {
        $locale ??= current_locale();
